...
function RadioNewZealandEnqueues(){
	...
	wp_enqueue_style( 'customStyle', get_template_directory_uri() . '/css/RadioNewZealandStyle.css', array(), '1.0.0', 'all' );
	...
	wp_enqueue_script( 'customScript', get_template_directory_uri() . '/js/RadioNewZealandScript.js', array(), '1.0.0', true);
}
//  Adding the action to the queue in wordpress
add_action('wp_enqueue_scripts','RadioNewZealandEnqueues');

//  Turning on Menus in WordPress
function RadioNewZealandSetUp(){
...
$customHeaderSetting = array(
		'default_image' => get_template_directory_uri() . 'imgs/Header-Image.jpg',
		'width' => 100,
		'height' => 50,
		'flex-height' => true,
		'flex-width' => true,
...
function RadioNewZealand_sidebar_setup(){
...
function RadioNewZealand_customize_color($wp_customize){ // wp_customize is a default wordpress function
